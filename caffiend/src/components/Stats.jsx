...
import {getTopThreeCoffees, calculateCoffeeStats, calculateCurrentCaffeineLevel, statusLevels} from "../utils";
 ...
 const warningLevel = caffeineLevel < statusLevels['low'].maxLevel ? 
  ...
  return (
    ...
    <div className="stats-grid">
      ...
      <StatCard title="Avg % of Caffeine">
